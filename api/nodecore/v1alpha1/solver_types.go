...
type SolverStatus struct {
	...
	DiscoveryPhase PhaseStatus `json:"discoveryPhase,omitempty"`
	...
	CandidatesPhase PhaseStatus `json:"candidatesPhase,omitempty"`
	...
	ReservationPhase PhaseStatus `json:"reservationPhase,omitempty"`
	...
	PurchasingPhase PhaseStatus `json:"purchasingPhase,omitempty"`
	...
	ConsumePhase PhaseStatus `json:"consumePhase,omitempty"`
