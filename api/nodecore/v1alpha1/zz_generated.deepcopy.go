...
func (in *SolverStatus) DeepCopyInto(out *SolverStatus) {
	*out = *in
	out.DiscoveryPhase = in.DiscoveryPhase
	out.CandidatesPhase = in.CandidatesPhase
	out.ReservationPhase = in.ReservationPhase
	out.PurchasingPhase = in.PurchasingPhase
	out.ConsumePhase = in.ConsumePhase
